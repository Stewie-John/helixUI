...
CREATE INDEX IF NOT EXISTS idx_codex_transcript_events_session
  ON codex_transcript_events(session_id, event_timestamp);

CREATE TABLE IF NOT EXISTS codex_runtime_aliases (
