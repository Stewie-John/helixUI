...
function getDatabasePath() {
    ...
    return process.env.DATABASE_PATH || path.join(dataRoot, 'auth.db');
}
...
function showHelp() {
    console.log(`
╔═══════════════════════════════════════════════════════════════╗
║                   HelixUI Command Line Tool                    ║
╚═══════════════════════════════════════════════════════════════╝

Usage:
  helix-ui [command] [options]
...
async function checkForUpdates(silent = false) {
    try {
        ...
        const latestVersion = execSync(`npm show ${packageJson.name} version`, { encoding: 'utf8' }).trim();
