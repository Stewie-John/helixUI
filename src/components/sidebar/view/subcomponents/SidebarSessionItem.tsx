...
export default function SidebarSessionItem({
  ...
  const isActive = activeSessions?.has(session.id) ?? false;
    ...
    <div className="group relative">
      ...
      <div className="hidden md:block">
        ...
        <Button
          variant="ghost"
          className={cn(
            'tech-sidebar-item-btn w-full justify-start p-2 h-auto font-normal text-left hover:bg-accent/50 transition-colors duration-200',
