  ...
  return (
    <div className={cn('md:space-y-1', isDeleting && 'opacity-50 pointer-events-none')}>
      <div className="group md:group">
        ...
        <div className={`tech-sidebar-item-wrapper hidden md:block${isSelected ? ' selected' : ''}`}>
        <Button
          variant="ghost"
          className={cn(
            'tech-sidebar-item-btn w-full justify-between p-2 h-auto font-normal hover:bg-accent/50',
