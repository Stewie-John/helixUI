...
export const getEditorStyles = (isDarkMode: boolean) => {
  return `
    .code-editor-vscode-shell {
      background: ${isDarkMode ? '#1e1e1e' : '#ffffff'} !important;
      color: ${isDarkMode ? '#cccccc' : '#1f2328'} !important;
    }

    .code-editor-vscode-shell > div:first-child {
      background: ${isDarkMode ? '#252526' : '#f3f3f3'} !important;
      border-color: ${isDarkMode ? '#3c3c3c' : '#d0d7de'} !important;
    }

    .code-editor-vscode-shell > div:first-child h3 {
      color: ${isDarkMode ? '#cccccc' : '#24292f'} !important;
    }

    .code-editor-vscode-shell > div:first-child p {
      color: ${isDarkMode ? '#858585' : '#57606a'} !important;
    }

    .code-editor-vscode-shell > div:last-child {
      background: ${isDarkMode ? '#007acc' : '#007acc'} !important;
      border-color: ${isDarkMode ? '#007acc' : '#007acc'} !important;
    ...
    .code-editor-vscode-shell .cm-editor {
      outline: none !important;
    }

    .code-editor-vscode-shell .cm-focused {
      outline: none !important;
    }
