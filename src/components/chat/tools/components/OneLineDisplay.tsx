                ...
                {cmdExpanded ? (
                  ...
                  <>
                    <code className="text-xs text-green-400 font-mono whitespace-pre-wrap break-all">
                      <span className="text-green-600 dark:text-green-500 select-none">$ </span>{safeValue}
                    </code>
                    <div className="flex justify-end mt-1">
                      <span className="text-[10px] text-green-600 dark:text-green-500 hover:text-green-400">▲ collapse</span>
                    </div>
                  </>
                ) : (
                  /* 折叠：首行 + 省略号 + 行数 */
                  <div className="flex items-center gap-2">
                    <code className="text-xs text-green-400 font-mono flex-1 truncate">
                      <span className="text-green-600 dark:text-green-500 select-none">$ </span>{cmdFirstLine}
                    </code>
                    <span className="text-[10px] text-green-600 dark:text-green-500 flex-shrink-0 whitespace-nowrap">
                      …+{cmdLines.length - 1} lines ▼
                    </span>
                  </div>
                )}
              </div>
