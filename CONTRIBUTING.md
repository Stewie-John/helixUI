...
Thanks for contributing to HelixUI. Please read this guide before starting.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/<your-username>/helixui.git
   cd helixui
   ```
...
- Make sure the complete verification passes (`npm run verify`)
